...
public class FornecedorController implements Serializable {
    ...
    @EJB
    private bean.FornecedorFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("FornecedorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("FornecedorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("FornecedorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class FornecedorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Fornecedor) {
                ...
                return getStringKey(o.getIdfornecedores());
            } else {
